...
FRAME$Red=as.logical(ifelse(as.numeric(FRAME$resp)==1,1,0))
FRAME$Green=as.logical(ifelse(as.numeric(FRAME$resp)==2,1,0))
...
response_window_agg_by_sub <- make_time_window_data(ET_DATA, aois=c("Red","Green","Mixed"),summarize_by = "ps")
...
library(readr)
pathsum='/Users/nicholashedger/Documents/Rivalry/Data/NICK_ims'
prefixsum='Trial'
